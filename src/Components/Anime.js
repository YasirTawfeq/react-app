  ...
  return (
    <div className=" m-5 md:m-3 ">
      ...
      <div className=" font-mono w-full h-10 bg-yellow-300 rounded-xl mt-2 mb-3 p-2 ">
        ...
        <div className=" text-black font-bold cursor-pointer hover:border-b-2 border-black">Episode<small className="">(new)</small></div>
        <div className=" text-black font-bold cursor-pointer hover:border-b-2 border-black" >English</div>
        <div className=" text-black font-bold cursor-pointer hover:border-b-2 border-black" >Kurdish</div>
        </div>
      </div>
